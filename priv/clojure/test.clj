...
(defn file-position
  ...
  {:added "1.1"
   :deprecated "1.2"}
  [n]
  (let [s (nth (stack/get-stacktrace) n)]
    [(stack/filename s) (stack/line-num s)]))
...
(defn inc-report-counter
  ...
  (when *report-counters*
    (var-set #'*report-counters*
             (update-in *report-counters* [name] (fnil inc 0)))))
...
(defn test-var
  ...
  [v]
  (when-let [t (find-var (:test (meta v)))]
